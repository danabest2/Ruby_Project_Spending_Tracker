...
spending_type1 = Spending_type.new({'type' => 'groceries'})
spending_type2 = Spending_type.new({'type' => 'entertainment'})
spending_type3 = Spending_type.new({'type' => 'transport'})
spending_type4 = Spending_type.new({'type' => 'wellbeing'})
spending_type5 = Spending_type.new({'type' => 'cleaning'})
